const questions = [
    ...
    {
    question: "Czym jest funkcja lambda w Pythonie?",
    optionA: "Funkcja anonimowa, która może mieć jedno wyrażenie",
    optionB: "Funkcja używana tylko do operacji matematycznych",
    optionC: "Funkcja, która nie zwraca żadnych wartości",
    optionD: "Funkcja zdefiniowana w bibliotece standardowej",
    correctOption: "optionA" // Poprawna odpowiedź: Funkcja anonimowa, która może mieć jedno wyrażenie
	},
	{
    question: "Jak działa funkcja `map()` w Pythonie?",
    optionA: "Stosuje podaną funkcję do każdego elementu iterowalnego i zwraca nową listę",
    optionB: "Zwraca elementy, które spełniają określony warunek",
    optionC: "Łączy wszystkie elementy listy w jeden wynik",
    optionD: "Usuwa powtarzające się elementy z listy",
    correctOption: "optionA" // Poprawna odpowiedź: Stosuje podaną funkcję do każdego elementu iterowalnego i zwraca nową listę
	},
    {
